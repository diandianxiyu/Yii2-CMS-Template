...
use app\components\pic2sdk\conf\Conf;
use app\components\pic2sdk\utils\UploadPolicy;
use app\components\pic2sdk\utils\MimeTypes;
use app\components\pic2sdk\utils\EncodeUtils;
use app\components\pic2sdk\UploadClientQuercus;
use app\components\pic2sdk\ManageClient;
use app\components\pic2sdk\UploadClient;
...
//        $uploadObj = "UploadClient" . $isQuercus;
        if($isQuercus == ""){
            $this->upload_client = new UploadClient($ak, $sk, $type, $this->upload_endpoint);
        }else{
            $this->upload_client = new UploadClientQuercus($ak, $sk, $type, $this->upload_endpoint);
        }
