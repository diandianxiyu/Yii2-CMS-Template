 ...
 * 
 * @author auto create
 * @since 1.0, 2015.09.12
 */
class AtbItemsCouponGetRequest
{
	/** 
	 * 商品所在地
	 **/
	...
	/** 
	 * 需返回的字段列表.可选值:open_iid,title,nick,pic_url,price,commission,commission_rate,commission_num,commission_volume,seller_credit_score,item_location,volume,coupon_price,coupon_rate,coupon_start_time,coupon_end_time,shop_type;字段之间用","分隔
	 **/
	private $fields;
