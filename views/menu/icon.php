...
<head>
<meta charset="utf-8"/>
<title>Metronic | UI Features - Font Icons</title>
...
<link id="style_color" href="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/css/themes/default.css" rel="stylesheet" type="text/css"/>
								...
								<div class="alert alert-success">
									<ul class="fa-ul">
										<li>
											...
											These icons work great with the <code>fa-spin</code> class. Check out the spinning icons example.
										</li>
									</ul>
								</div>
								<div class="row margin-bottom-20">
						...
						<div class="page-quick-sidebar-chat-users" data-rail-color="#ddd" data-wrapper-class="page-quick-sidebar-list">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar3.jpg" alt="...">
								...
								<li class="media">
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar1.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar4.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar2.jpg" alt="...">
									<div class="media-body">
							...
							<ul class="media-list list-items">
								<li class="media">
									...
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar6.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar7.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar8.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar9.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar10.jpg" alt="...">
									<div class="media-body">
								...
								<li class="media">
									...
									<img class="media-object" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar11.jpg" alt="...">
									<div class="media-body">
						...
						<div class="page-quick-sidebar-item">
							<div class="page-quick-sidebar-chat-user">
								...
								<div class="page-quick-sidebar-chat-user-messages">
									<div class="post out">
										<img class="avatar" alt="" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar3.jpg"/>
										<div class="message">
									...
									<div class="post in">
										<img class="avatar" alt="" src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/layout/img/avatar2.jpg"/>
										<div class="message">
											<span class="arrow"></span>
