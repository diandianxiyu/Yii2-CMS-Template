...
<h3 class="page-title">
    Version management <small>  iOS version added  </small>
</h3>
<div class="page-bar">
    ...
    <div class="page-toolbar">
        <div class="btn-group pull-right">
            ...
            <ul class="dropdown-menu pull-right" adminuser="menu">
                <li>
                    <a href="<?php echo Yii::$app->urlManager->createUrl(['versionup/create', 'type' => 2]) ?>">iOS</a>
...
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<?php echo \Yii::$app->view->renderFile('@app/views/versionup/_iosform.php', [ 'model' => $model]); ?>
...
<script src="<?php echo Yii::$app->request->baseUrl ?>/metronic/global/plugins/icheck/icheck.min.js"></script>
...
<script src="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/pages/scripts/form-icheck.js"></script>
