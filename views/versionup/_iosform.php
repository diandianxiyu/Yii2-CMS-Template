                        ...
                        <?php $form = ActiveForm::begin([
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    <label class="control-label col-md-3">Download address <span class="required" aria-required="true">
                                    * </span>
                                    </label>
                                    <div class="col-md-4">
                                        <input type='text' name='url' class='form-control' placeholder='Please enter the APP_Store address.' value='<?php echo @$url?>' onblur='yanurl()' id='urlv'>
                                        <span id="spurl"></span>
                                    </div>
                                </div>
...
function yanurl(){
    ...
    var regs=/^https:\/\/([\w-]+(\.[\w-]+)+(\/[\w-     .\/\?%&=\u4e00-\u9fa5]*)?)?$/;
    if(urlv==''){
        $('#spurl').html("<font color='red'>Please fill in the address</font>");
    }else{
        if(!reg.test(urlv) && !regs.test(urlv) ){
            $('#spurl').html("<font color='red'>Please enter the correct address.</font>");
        }else{
            $('#spurl').html("");
        }
    }
