...
<h3 class="page-title">
    Administrator  management  <small>  Administrator edit  </small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo Yii::$app->urlManager->createUrl(['adminuser/update', 'id' => $model->id] ) ?>">Administrator edit</a>
        </li>
    </ul>
...
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<?php echo \Yii::$app->view->renderFile('@app/views/adminuser/_form.php', [ 'model' => $model ]); ?>
