...
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo Yii::$app->urlManager->createUrl('assignment/index')?>">Authority management</a>
            <i class="fa fa-angle-right"></i>
        </li>
        <li>
...
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<?php echo \Yii::$app->view->renderFile('@app/views/assignment/_form.php', [ 'model' => $model, 'roleArray' => $roleArray,  'adminResult' => $adminResult ]); ?>
