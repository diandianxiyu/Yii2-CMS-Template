...
<div class="row">
    <div class="col-md-12 ">
        <h3 class="page-title">
            Role management <small> Role list  </small>
        </h3>
        <div class="page-bar">
            <ul class="page-breadcrumb">
                ...
                <li>
                    <a href="<?php echo Yii::$app->urlManager->createUrl('role/index') ?>">Role management</a>
                    <i class="fa fa-angle-right"></i>
                </li>
                <li>
                    <a href="<?php echo Yii::$app->urlManager->createUrl('role/index') ?>">Role list</a>
                </li>
            </ul>
        ...
        <div class="portlet box green">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-cogs"></i>Role list
                </div>
            </div>
                    ...
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php foreach ($models as $val) { ?>
                                <tr>
                                    <td> <a href="<?php echo Yii::$app->urlManager->createUrl(['role/view', "name" => $val->name]) ?>"> <?php echo $val->name ?> </a> </td>
                                    ...
                                    <td> 
                                        ...
                                        <a href="<?php echo Yii::$app->urlManager->createUrl(['role/sharechild', "name" => $val->name]) ?>" class="btn btn-xs blue">Authority assignment <i class="fa fa-plus"></i> </a>
                                        <a href="<?php echo Yii::$app->urlManager->createUrl(['role/update', "name" => $val->name]) ?>" class="btn btn-xs red"> Modify <i class="fa fa-edit"></i> </a>
                                        <a href="<?php echo Yii::$app->urlManager->createUrl(['role/delete', "name" => $val->name]) ?>" onclick="if (!confirm('You sure you want to delete <?php echo $val->name ?> ?'))
