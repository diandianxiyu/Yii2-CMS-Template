...
<h3 class="page-title">
    Role management <small>  Role change  </small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo Yii::$app->urlManager->createUrl(['role/update', 'name' => $model->name] ) ?>">Role change</a>
        </li>
    </ul>
...
<!-- END PAGE HEADER-->
<!-- BEGIN PAGE CONTENT-->
<?php echo \Yii::$app->view->renderFile('@app/views/role/_form.php', [ 'model' => $model ]); ?>
