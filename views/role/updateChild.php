...
<h3 class="page-title">
    Role management <small>  Role assignment  </small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo Yii::$app->urlManager->createUrl([ 'role/createChild', 'name' => $model->name]) ?>">Role rights change</a>
        </li>
    </ul>
...
<?php echo \Yii::$app->view->renderFile('@app/views/role/_formChild.php', [ 'model' => $model, 'permissions' => $permissions]); ?>
