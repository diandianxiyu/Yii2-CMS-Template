...
?>
<link href="<?php echo Yii::$app->request->baseUrl ?>/metronic/admin/pages/css/error.css" rel="stylesheet" type="text/css"/>
...
<!-- BEGIN PAGE HEADER-->
<h3 class="page-title">
    Make mistakes <small>This is an error page</small>
</h3>
<div class="page-bar">
...
<div class="row">
    <div class="col-md-12 page-500">
        ...
        <div class=" details">
            <h3><?= $message ?></h3>
            <p>
                <a href="<?= 'http://' . $_SERVER['SERVER_NAME'] ?>" >Click back to the home page</a><br>
                <br><br>
            </p>
        </div>
    </div>
