...
<h3 class="page-title">
    Authority management <small>  Permission modification  </small>
</h3>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            <a href="<?php echo Yii::$app->urlManager->createUrl(['permission/update', 'name' => $model->name]) ?>">Permission modification</a>
        </li>
    </ul>
